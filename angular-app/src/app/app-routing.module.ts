...
const routes: Routes = [
  ...
  { path : "admin" , component : AdminTemplateComponent , canActivate : [AuthGuard] , children:[
    ...
    { path : "loadStudents" , component : LoadStudentsComponent , canActivate : [AuthrizationGuard] , data : { roles : ['ADMIN']} },
    { path : "loadPayments" , component : LoadPaymentsComponent , canActivate : [AuthrizationGuard] , data : { roles : ['ADMIN']} },
  ] },
];
